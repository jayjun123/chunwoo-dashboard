// 브라우저에서 LONGgisung.xlsx 파일을 NEWgisung.xlsx로 업로드하는 스크립트
// 브라우저 콘솔에서 실행하세요

const uploadLongGisungToFirebase = async () => {
  try {
    console.log('🚀 LONGgisung.xlsx 파일을 NEWgisung.xlsx로 업로드 시작...');
    ...
    try {
      ...
      console.warn('⚠️ 기존 NEWgisung.xlsx 삭제 실패 (무시):', deleteError);
    }
    
    // 새 파일 업로드
    console.log('📤 LONGgisung.xlsx을 NEWgisung.xlsx로 업로드 중...');
    ...
    console.log('🎉 LONGgisung.xlsx을 NEWgisung.xlsx로 업로드 완료!');
